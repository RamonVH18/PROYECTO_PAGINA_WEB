...
public class ControladorUsuario {
    ...
    public String getAllUsuariosTabla() {
        ...
        for (Usuario usuario : modeloUsuario.getAllUsuarios()) {
            // Fila de la tabla
            html.append("<tr>")
                    .append("<td>").append(usuario.getNumero()).append("</td>")
            ...
            html.append("<div class='modal fade' id='editarUsuarioModal").append(usuario.getId())
                    ...
                    .append("<div class='mb-3'><label class='form-label'>Apellido paterno</label>")
                    ...
                    .append("<div class='mb-3'><label class='form-label'>Contraseña</label>")
                    .append("<input type='password' name='contrasenia' class='form-control' value='").append(usuario.getContrasenia()).append("' required></div>")
                    .append("<div class='mb-3'><label class='form-label'>Rol</label>")
